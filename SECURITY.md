...
[Download the latest version](https://github.com/amitashwinibhagat/claude-usage-tracker-private/releases/latest)
...
1. Go to the [Security tab](https://github.com/amitashwinibhagat/claude-usage-tracker-private/security/advisories)
...
- Download only from official sources:
  - [GitHub Releases](https://github.com/amitashwinibhagat/claude-usage-tracker-private/releases)
...
For non-security related issues, please use [GitHub Issues](https://github.com/amitashwinibhagat/claude-usage-tracker-private/issues).
